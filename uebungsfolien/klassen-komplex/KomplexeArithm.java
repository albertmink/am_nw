...
public class KomplexeArithm {
  public static void main( String[] args ) {
    ...
    System.out.println( "Geben Sie den Real- und Imaginaerteile einer " + "komplexen Zahl z ein:" );
    double x = sc.nextDouble();
    double y = sc.nextDouble();
    Komplex z = new Komplex( x, y );

    System.out.println( "Geben Sie den Real- und Imaginaerteile einer " + "komplexen Zahl w ein:" );
    x = sc.nextDouble();
    y = sc.nextDouble();
