...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA,firstline=1,lastline=12]{\getexercisefolder/Komplex.java}
\end{frame}
...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA,firstline=19,lastline=22]{\getexercisefolder/Komplex.java}
\end{frame}
...
\lstinputlisting[style=JAVAsmall]{\getexercisefolder/KomplexeArithm.java}
\end{frame}
