...
\begin{frame}%
  \frametitle{\stitle}%
\lstinputlisting[style=JAVA]{strukt-artikel/Artikel.java}
\end{frame}
...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA]{strukt-artikel/Artikelverwaltung21.java}
\end{frame}
...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA]{strukt-artikel/Artikelverwaltung22.java}
\end{frame}
...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA]{strukt-artikel/Artikelverwaltung23.java}
\end{frame}
...
\end{enumerate}
\pause
\lstinputlisting[style=JAVA]{strukt-artikel/Artikelverwaltung24.java}
\end{frame}
...
\lstinputlisting[style=JAVA]{strukt-artikel/Artikelverwaltung3.java}
\end{frame}
