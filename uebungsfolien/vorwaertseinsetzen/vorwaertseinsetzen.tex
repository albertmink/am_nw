...
\]
\begin{itemize}
\item Erstellen Sie eine Funktion \code{vorwaertseinsetzen}, die eine untere Dreiecks\-matrix~$ A $ und einen Vektor $ b $ erh\"alt und den L\"osungsvektor $ y $ zur\"uck gibt.
\end{itemize}
\end{frame}
