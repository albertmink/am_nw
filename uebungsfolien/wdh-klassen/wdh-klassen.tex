...
\lstinputlisting[style=JAVA]{wdh-klassen/Person.java}
\begin{description}
\item[Motivation]
...
\begin{frame}%
  \frametitle{\sstitle}%
\lstinputlisting[style=JAVA]{wdh-klassen/MinimalExample.java}
\end{frame}
...
\begin{frame}%
  \frametitle{\sstitle}%
\lstinputlisting[style=JAVA]{wdh-klassen/MinimalExampleZu.java}
\begin{description}
...
\lstinputlisting[style=JAVA]{wdh-klassen/PersonK.java}
\end{frame}
...
\lstinputlisting[style=JAVA]{wdh-klassen/MinimalExampleFelder.java}
\end{frame}
