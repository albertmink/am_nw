...
\item[Nomenklatur] Instanzen der Klasse \code{Person} hei\ss en Objekte.
\end{description}
\end{frame}
...
Der Konstruktor tr\"agt den Namen der Klasse -- hier: \code{PersonK} -- und dient zur Instantiierung von Klassen.
