...
\begin{itemize}
\item Vollst\"andige Dokumentation \BLUE{\url{http://docs.oracle.com/javase/8/docs/api/}}
\item Umfassende Internet Tutorien \BLUE{\url{https://www.tutorialspoint.com/java/}} oder \BLUE{\url{https://www.javatpoint.com/java-tutorial}}
\end{itemize}
\medskip
...
Auf der Seite \BLUE{\url{https://www.compilejava.net}} k\"onnen Sie sehr bequem kleinere Programme compilieren und ausf\"uhren.
